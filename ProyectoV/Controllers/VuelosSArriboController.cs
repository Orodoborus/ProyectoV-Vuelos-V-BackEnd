...
{
    public class VuelosSArriboController : ApiController
    {
        // GET: api/VuelosSArribo
        string mensaje_error;
        int numero_error;
        public List<Vuelos> Get()
        {
            List<Vuelos> listaUser = new Vuelos().GetFlightsSArribo(ref mensaje_error, ref numero_error);
            return listaUser;
        }

        // GET: api/VuelosSArribo/5
